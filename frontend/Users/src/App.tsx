...
import AdminDroneMonitor from "@/pages/AdminDroneMonitor";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/order/:orderId/track" component={TrackDeliveryPage} />
      <Route path="/order/:orderId/pin" component={OrderPinPage} />
      <Route path="/admin/drone-monitor" component={AdminDroneMonitor} />
