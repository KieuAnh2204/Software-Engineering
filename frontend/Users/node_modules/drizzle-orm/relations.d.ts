import { type AnyTable, type InferModelFromColumns, Table } from "drizzle-orm/tablem/table";
import { type AnyColumn, Column } from "drizzle-orm/column/column";
import { entityKind } from "drizzle-orm/entity/entity";
import { and, asc, between, desc, exists, ilike, inArray, isNotNull, isNull, like, not, notBetween, notExists, notIlike, notInArray, notLike, or } from "drizzle-orm/sql/expressionss";
import { type Placeholder, SQL, sql } from "drizzle-orm/sql/sqlsql/sql";
import type { Assume, ColumnsWithTable, Equal, Simplify, ValueOrArray } from "drizzle-orm/utilsm/utils";
...
export declare function getOperators(): {
    ...
    eq: import("drizzle-orm/expressionsessions").BinaryOperator;
    exists: typeof exists;
    gt: import("drizzle-orm/expressionsessions").BinaryOperator;
    gte: import("drizzle-orm/expressionsessions").BinaryOperator;
    ilike: typeof ilike;
    inArray: typeof inArray;
    isNull: typeof isNull;
    isNotNull: typeof isNotNull;
    like: typeof like;
    lt: import("drizzle-orm/expressionsessions").BinaryOperator;
    lte: import("drizzle-orm/expressionsessions").BinaryOperator;
    ne: import("drizzle-orm/expressionsessions").BinaryOperator;
    not: typeof not;
