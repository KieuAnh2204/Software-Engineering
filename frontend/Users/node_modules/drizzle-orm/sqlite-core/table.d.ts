import type { BuildColumns } from "drizzle-orm/column-builderuilder";
import { entityKind } from "drizzle-orm/entityentity";
import { Table, type TableConfig as TableConfigBase, type UpdateTableConfig } from "drizzle-orm/table/table";
import type { CheckBuilder } from "drizzle-orm/sqlite-core/checks/sqlite-core/checks";
import { type SQLiteColumnBuilders } from "drizzle-orm/sqlite-core/columns/allte-core/columns/all";
import type { SQLiteColumn, SQLiteColumnBuilderBase } from "drizzle-orm/sqlite-core/columns/commoncore/columns/common";
import type { ForeignKeyBuilder } from "drizzle-orm/sqlite-core/foreign-keyse-core/foreign-keys";
import type { IndexBuilder } from "drizzle-orm/sqlite-core/indexessqlite-core/indexes";
import type { PrimaryKeyBuilder } from "drizzle-orm/sqlite-core/primary-keyse-core/primary-keys";
import type { UniqueConstraintBuilder } from "drizzle-orm/sqlite-core/unique-constrainte/unique-constraint";
