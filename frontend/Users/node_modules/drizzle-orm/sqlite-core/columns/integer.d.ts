import type { ColumnBuilderBaseConfig, ColumnDataType, HasDefault, IsPrimaryKey, MakeColumnConfig, NotNull } from "drizzle-orm/column-builderder";
import type { ColumnBaseConfig } from "drizzle-orm/columnumn";
import { entityKind } from "drizzle-orm/entityity";
import type { OnConflict } from "drizzle-orm/sqlite-core/utils/sqlite-core/utils";
import { type Equal, type Or } from "drizzle-orm/utilsils";
import type { AnySQLiteTable } from "drizzle-orm/sqlite-core/table/sqlite-core/table";
import { SQLiteColumn, SQLiteColumnBuilder } from "drizzle-orm/sqlite-core/columns/common/sqlite-core/columns/common";
