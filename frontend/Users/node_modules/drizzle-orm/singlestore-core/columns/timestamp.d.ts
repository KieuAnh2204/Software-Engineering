...
import { SingleStoreDateBaseColumn, SingleStoreDateColumnBaseBuilder } from "drizzle-orm/singlestore-core/columns/date.commonlestore-core/columns/date.common";
...
export declare class SingleStoreTimestampBuilder<T extends ColumnBuilderBaseConfig<'date', 'SingleStoreTimestamp'>> extends SingleStoreDateColumnBaseBuilder<T, SingleStoreTimestampConfig> {
    ...
    defaultNow(): import("drizzle-orm/column-builderder").HasDefault<this>;
}
